...
<html lang="pt-br">
  ...
  <body class="bg-custom-light">
    ...
    <div class="login-container">
      <h2 class="text-center text-custom-dark mb-4">Login</h2>
      <form>
        <div class="mb-3">
        ...
        <div class="text-center mt-3">
          <a href="#" class="text-custom-dark">Esqueceu a senha?</a>
        </div>
        <div class="text-center mt-3">
          <p class="text-custom-dark">Não tem uma conta? <a href="#" class="text-custom-dark">Cadastre-se</a></p>
        </div>
      </form>
    </div>
